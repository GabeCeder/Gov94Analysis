...
model_4 <- lm(running_sum_pop ~ timely + tests_per_million + pop_millions + gdp_billions + health_exp_gdp_2016 + out_pocket_exp_2016 + private_exp_pp_2016 + people_per_sq_km + informal_sector + authoritarian, data = xx)
summary(model_4)
