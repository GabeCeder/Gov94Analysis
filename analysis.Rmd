...
ggplot(test, aes(days_since_100, running_sum, color = country)) +
  ...
  labs(
    ...
    subtitle = "Brazil's cases have grown faster than other Lating American Countries",
       y = "Cases",
...
summary(lm(running_sum ~ gini_2017 + pop_2018 + gdp_2018 + health_exp_gdp_2016 + out_pocket_exp_2016 + private_exp_pp_2016, data = b)) 
```
